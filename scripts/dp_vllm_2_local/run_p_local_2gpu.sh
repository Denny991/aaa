...
echo "=========================================="
echo "Prefill (P) - PD 分离部署 [同容器双卡，GPU 0]"
echo "=========================================="
...
# ========== vLLM Prefill 实例启动 ==========
echo "[vLLM] Starting Prefill instance on port 8100..."
